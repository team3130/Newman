...
public class GoToPickupCube extends CommandBase {
  // required subsystem
   ...
   */
  public GoToPickupCube(RotaryArm rotary, ExtensionArm extension) {
    m_rotaryArm = rotary;
  ...
  public void initialize() {
    ...
    m_rotaryArm.makeSetpointGround();
  ...
  public void execute() {
    ...
    if (m_rotaryArm.outsideBumper() && !hasStartedExtended) { // may need way outside bumper
      m_extensionArm.extendArmToGroundForCube();
