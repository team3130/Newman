 ...
 */
public class GoToPickupOffGround extends PlacementSetpoint {
  ...
  public GoToPickupOffGround(RotaryArm rotaryArm, ExtensionArm extensionArm) {
      ...
      super(rotaryArm, extensionArm, Constants.offGroundAngleCone, Constants.Extension.offGroundPosition, 12.5);
  }
}
